...
/* ======================================================
   TYPES (SUPPORT SINGLE + MULTIPLE IMAGES)
====================================================== */
interface GalleryItem {
  id: string;
  type: 'image' | 'video';
...
export default function GalleryItemsPage() {
  ...
  /* AUTH CHECK */
  useEffect(() => {
    if (!isUserLoading && !user) router.replace('/admin');
  }, [user, isUserLoading, router]);
...
====================================================== */
  const renderThumbnail = (item: GalleryItem) => {
    ...
    if (item.type === 'video' && item.url) {
      const id = item.url.includes('http')
